        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              ...
              para a locação do equipamento desejado.
            </p>
          </div>
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <optgroup label="Toshiba">
                          <option value="toshiba-aplio-mx">Toshiba Aplio MX</option>
                          <option value="toshiba-xario-xg">Toshiba Xario XG</option>
                          <option value="toshiba-nemio-mx">Toshiba Nemio MX</option>
                        </optgroup>
                        <optgroup label="GE">
                          <option value="ge-logiq-e">GE Logiq E</option>
                          <option value="ge-logiq-c5">GE Logiq C5</option>
                          <option value="ge-logiq-p5">GE Logiq P5</option>
                          <option value="ge-logiq-p6">GE Logiq P6</option>
                          <option value="ge-logiq-f8">GE Logiq F8</option>
                          <option value="ge-logiq-p3">GE Logiq P3</option>
                          <option value="ge-voluson-e6">GE Voluson E6</option>
                        </optgroup>
                        <optgroup label="Philips">
                          <option value="philips-hd7">Philips HD7</option>
                          <option value="philips-affiniti-50">Philips Affiniti 50</option>
                          <option value="philips-hd11">Philips HD11</option>
                        </optgroup>
                        <optgroup label="Medison">
                          <option value="medison-sonoace-x8">Medison Sonoace X8</option>
                          <option value="medison-accuvix-v10">Medison Accuvix V10</option>
                        </optgroup>
                        <optgroup label="Samsung">
                          <option value="samsung-h60">Samsung H60</option>
                          <option value="samsung-accuvix-xg">Samsung Accuvix XG</option>
                          <option value="samsung-r7">Samsung R7</option>
                        </optgroup>
                      </select>
                    </div>
                  </div>
